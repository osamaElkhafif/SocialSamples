...
{
    public class RelatedToTextPostFactory<P> : AbstractRelatedToPostsFactory<P>
        where P:class,IIPost
    {
            ...
            (ApplicationUser sender, ApplicationUser receiver, IIPost post)
        {
            ...
            return 
                new UserInteractedToTextPostDbNotification()
            {
            ...
            IIPost post)
        {
            ...
            return 
                new UserCommentedToTextPostDbNotification()
            {
                dbNotification = dbNotification,
                PostId = post.Id
        ...
        public override IISharedPost SharedPostFactory(ApplicationUser appUser, SharedPostModel sharedPostModel)
        {
            ...
            return new SharedTextPost()
            {

                actualTextPostId = sharedPostModel.postId,
        ...
        {
            return new TextPostCommentInteraction()
            {
                userId = sender.Id,
