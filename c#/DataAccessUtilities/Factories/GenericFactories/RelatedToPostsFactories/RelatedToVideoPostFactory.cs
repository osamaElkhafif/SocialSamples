...
{
    public class RelatedToVideoPostFactory<P>: AbstractRelatedToPostsFactory<P>
        where P:class,IIPost
    {
            ...
            (ApplicationUser sender, ApplicationUser receiver, IIPost post)
        {
            ...
            return 
                new UserInteractedToVideoPostDbNotification()
            {
            ...
            , IIPost post)
        {
            ...
            return 
                ...
                new UserCommentedToVideoPostDbNotificaion()
            {
                dbNotification = dbNotification,
                PostId = post.Id
        ...
        public override IISharedPost SharedPostFactory(ApplicationUser appUser, SharedPostModel sharedPostModel)
        {
            ...
            return new SharedVideoPost()
            {

                actualVideoPostId = sharedPostModel.postId,
        ...
        {
            return new VideoPostCommentInteraction()
            {
                userId = sender.Id,
