...
{
    public class RelatedToSharedTextPostFactory<P> : AbstractRelatedToPostsFactory<P>
        where P:class,IIPost
    {
            ...
            (ApplicationUser sender, ApplicationUser receiver, IIPost post)
        {
            ...
            return 
                ...
                new UserInteractedToSharedTextPostDbNotification()
            {
            ...
            IIPost post)
        {
            ...
            return 
                new UserCommentedToSahredTextPostDbNotification()
            {
                dbNotification = dbNotification,
                PostId = post.Id
        ...
        {
            return new SharedTextPostCommentInteraction()
            {
                userId = sender.Id,
