...
{
    public class RelatedToVideoPostActionsProvider:AbstractRelatedToPostsActionsProvider
    {

        public IServiceProvider ServiceProvider { get; }

        public RelatedToVideoPostActionsProvider(IServiceProvider serviceProvider)
        {
        ...
        public override IPostsInteractionsRepository<IIPostInteraction, IIPost> getPostsInteractionRepository()
        {
            ...
            return
                   ...
                   ServiceProvider.GetService(typeof(IPostsInteractionsRepository<VideoPostInteraction, VideoPost>));
        ...
        public override IGetPostsGenericRepository<IIPost> getPostsGenericRepository()
        {
            return
             ...
             ServiceProvider.GetService(typeof(IGetPostsGenericRepository<VideoPost>));
        }
            ...
            IIUserCommentedToPostDbNotification, IIPost> GetNotificationGenericRepository()
        {
            return (INotificationGenericRepository<IIUserInteractedToPostDbNotification,
                ...
                <UserInteractedToVideoPostDbNotification, UserCommentedToVideoPostDbNotificaion, VideoPost>));
        }
        ...
        public override IPostsCommentsRepository<IIPost, IIPostComment> GetPostsCommentRepository()
        {
            return
                (IPostsCommentsRepository<IIPost, IIPostComment>)
                 ServiceProvider
                .GetService(typeof(IPostsCommentsRepository<VideoPost, VideoPostComment>));
        }
        ...
        public override ISharedPostsRepository<IIPost,IISharedPost> GetSharedPostsRepository()
        {
            return
                (ISharedPostsRepository<IIPost,IISharedPost>)
                 ServiceProvider
                 .GetService(typeof(ISharedPostsRepository<VideoPost,SharedVideoPost>));
            ...
            getPostCommentInteractionRepository()
        {
            return
                    (ICommentsInteractionRepository<IIPost, IIPostComment, IIPostCommentInteraction>)
                     ServiceProvider
                     .GetService(typeof(ICommentsInteractionRepository<VideoPost,
                     VideoPostComment, VideoPostCommentInteraction>));
        }
